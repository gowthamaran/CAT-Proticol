...
install_env_and_full_node() {
    ...
    # Create configuration file with updated mempool minimum fee
    echo '{
    ...
    # Set mempool minimum fee in bitcoin.conf
    echo "minrelaytxfee=0.00045000" >> ~/.bitcoin/bitcoin.conf
    
    # Restart Bitcoin Core to apply new settings
